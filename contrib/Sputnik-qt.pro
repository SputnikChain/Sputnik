...
RESOURCES += src/qt/Sputnik.qrc src/qt/Sputnik_locale.qrc

TRANSLATIONS += src/qt/locale/Sputnik_bg.ts \
                src/qt/locale/Sputnik_de.ts \
                src/qt/locale/Sputnik_en.ts \
                src/qt/locale/Sputnik_es.ts \
                src/qt/locale/Sputnik_fi.ts \
                src/qt/locale/Sputnik_fr.ts \
                src/qt/locale/Sputnik_it.ts \
                src/qt/locale/Sputnik_ja.ts \
                src/qt/locale/Sputnik_pl.ts \
                src/qt/locale/Sputnik_pt.ts \
                src/qt/locale/Sputnik_ru.ts \
                src/qt/locale/Sputnik_sk.ts \
                src/qt/locale/Sputnik_sv.ts \
                src/qt/locale/Sputnik_vi.ts \
                src/qt/locale/Sputnik_zh_CN.ts \
                src/qt/locale/Sputnik_zh_TW.ts

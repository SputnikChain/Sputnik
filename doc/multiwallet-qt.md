...
In order to support loading of multiple wallets in Sputnik-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is Sputnik.cpp.
...
Changes to Sputnik.cpp
----------------------
Sputnik.cpp is the entry point into Sputnik-qt, and as such, will require some minor modifications to provide hooks for

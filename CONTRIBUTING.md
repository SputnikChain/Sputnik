Contributing to Sputnik Core
============================

The Sputnik Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Sputnik Core project, and is not to be
confused with overall Sputnik Network Protocol consensus changes.

Whether a pull request is merged into Sputnik Core rests with the project merge
...
Patches that change Sputnik consensus rules are considerably more involved than
...
Where a patch set proposes to change the Sputnik consensus, it must have been
...
The project leader is the release manager for each Sputnik Core release.

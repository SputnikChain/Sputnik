...
#   c) node1 mines 32 blocks, so now node 0 has 60001Sputnik, node 1 has 4250Sputnik, node2 has none.
#   d) node0 sends 601 Sputnik to node2, in two transactions (301 Sputnik, then 300 Sputnik).

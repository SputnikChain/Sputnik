...
public:
    ...
    void setZSputnikControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzSputnik_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzSputnik_clicked();
    void on_pushButtonZSputnikControl_clicked();

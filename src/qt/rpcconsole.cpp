...
// Copyright (c) 2015-2018 The Sputnik developers
                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzSputnikPathCustom = GetArg("-zSputnikbackuppath", "");
    ...
    if(!strzSputnikPathCustom.empty()) {
        ui->wallet_customzSputnikbackuppath->setText(QString::fromStdString(strzSputnikPathCustom));
        ui->wallet_customzSputnikbackuppath_label->setVisible(true);
        ui->wallet_customzSputnikbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzSputnikPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Sputnik RPC console.") + "<br>" +

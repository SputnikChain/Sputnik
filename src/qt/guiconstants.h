...
/* Sputnik GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Sputnik"
#define QAPP_ORG_DOMAIN "Sputnik.org"
#define QAPP_APP_NAME_DEFAULT "Sputnik-Qt"
#define QAPP_APP_NAME_TESTNET "Sputnik-Qt-testnet"

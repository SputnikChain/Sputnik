...
/** Utility functions used by the Sputnik Qt UI.
 */
namespace GUIUtil
{
...
// Render Sputnik addresses in monospace font
...
// Parse "Sputnik:" URI into recipient object, return true on successful parsing

...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("Sputnik Stake");
    case TransactionRecord::StakeZSputnik:
        return tr("zSputnik Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Sputnik to zSputnik");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zSputnik");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Sputnik from zSputnik");
    case TransactionRecord::ZerocoinSpend_Change_zSputnik:
        return tr("Minted Change as zSputnik from zSputnik Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zSputnik to Sputnik");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zSputnik:
        return tr("Anonymous (zSputnik Transaction)");
    case TransactionRecord::StakeZSputnik:
        return tr("Anonymous (zSputnik Stake)");
    case TransactionRecord::SendToSelf:
    default:

                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sputnik Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Sputnik address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Sputnik: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sputnik Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sputnik Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Sputnik"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Sputnik addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Sputnik addresses"));
    ...
    openAction->setStatusTip(tr("Open a Sputnik: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gentaium Core help message to get a list with possible Sputnik command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sputnik Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Sputnik network", "", count));
}
...
{
    QString strTitle = tr("Sputnik Core"); // default title

...
#ifndef Sputnik_ZSputnikTRACKER_H
#define Sputnik_ZSputnikTRACKER_H
...
public:
    CzSputnikTracker(std::string strWalletFile);
    ~CzSputnikTracker();
...
#endif //Sputnik_ZSputnikTRACKER_H

...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Sputnik Core Sputnik-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Sputnik-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Sputnik transaction") + "\n" +
                               "  Sputnik-tx [options] -create [commands]   " + _("Create hex-encoded Sputnik transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Sputnik transaction

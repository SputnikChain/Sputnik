...
public:
    ...
    bool WriteZSputnikSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZSputnikSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZSputnikSeed_deprecated(uint256& seed);
    bool EraseZSputnikSeed();
    bool EraseZSputnikSeed_deprecated();

    bool WriteZSputnikCount(const uint32_t& nCount);
    bool ReadZSputnikCount(uint32_t& nCount);

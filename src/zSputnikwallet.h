...
#ifndef Sputnik_ZSputnikWALLET_H
#define Sputnik_ZSputnikWALLET_H
...
public:
    CzSputnikWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZSputnik(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZSputnik(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //Sputnik_ZSputnikWALLET_H
